...
read-only evidence QA, not an artifact or intent-completeness gate. Every authoring stage runs inline
because intent grounding needs raw context, not a summary (Core principles).
