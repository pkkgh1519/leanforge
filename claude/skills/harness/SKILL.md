...
- distill repeated Leanforge archives into run-compatible repo-local review/explore/checklist skills
...
5. Include:
   ...
   - expected outputs
   - validation notes
6. For a skill meant to help `Leanforge Run`, make it a review/explore/checklist lens and include a `## Leanforge Run usage` section. Follow `references/run-compatible-skill-guide.md`.
